...
import { Component, Input, Output, EventEmitter, Inject, Injectable, Directive, HostBinding, PLATFORM_ID, Pipe, HostListener, ElementRef, ViewChildren, ViewChild, NgModule, defineInjectable, inject } from '@angular/core';
