...
import { Component, Input, Output, EventEmitter, Inject, Injectable, Directive, HostBinding, PLATFORM_ID, Pipe, ComponentFactoryResolver, Injector, Renderer2, TemplateRef, ViewContainerRef, HostListener, ElementRef, ViewChild, ViewChildren, defineInjectable, inject, NgModule } from '@angular/core';
