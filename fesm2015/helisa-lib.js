...
import { Component, Input, Output, EventEmitter, Inject, Injectable, Pipe, ComponentFactoryResolver, Directive, Injector, Renderer2, TemplateRef, ViewContainerRef, HostBinding, PLATFORM_ID, HostListener, ElementRef, ViewChild, ViewChildren, defineInjectable, inject, NgModule } from '@angular/core';
