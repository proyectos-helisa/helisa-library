...
import { Component, Input, Output, EventEmitter, Inject, Injectable, Directive, HostBinding, PLATFORM_ID, Pipe, HostListener, ElementRef, NgModule, ViewChild, ViewChildren, defineInjectable, inject } from '@angular/core';
