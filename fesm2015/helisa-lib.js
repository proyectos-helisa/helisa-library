...
import { Component, Input, Output, EventEmitter, Inject, Injectable, Pipe, Directive, HostBinding, PLATFORM_ID, HostListener, ElementRef, ViewChild, ViewChildren, defineInjectable, inject, NgModule } from '@angular/core';
