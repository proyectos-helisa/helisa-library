...
import { EventEmitter, Component, Input, ViewChild, Output, Inject, Injectable, ViewChildren, ElementRef, HostListener, Directive, PLATFORM_ID, HostBinding, Pipe, ContentChild, NgModule } from '@angular/core';
