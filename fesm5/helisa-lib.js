...
import { Component, Input, Output, EventEmitter, Inject, Injectable, Directive, HostBinding, PLATFORM_ID, Pipe, HostListener, ElementRef, ViewChildren, NgModule, defineInjectable, inject, ViewChild } from '@angular/core';
